...
function MovieCard({ movie, onToggleWatched, onDelete }) {
  ...
  return (
    <div
      className={`bg-[#161b2e] rounded-2xl overflow-hidden border transition-all duration-200 hover:shadow-xl hover:-translate-y-1 ${
        movie.watched ? 'border-blue-500/30' : 'border-[#252b45]'
      }`}
    >
